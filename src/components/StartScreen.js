...
export default function StartScreen(props) {
    ...
    const startButton = (zapGoal >= 1 && deck.length > 0) ? <button className="active" onClick={fncOpenDeck}>Iniciar Recall!</button> : <button className="blocked">Iniciar Recall!</button>
    ...
    return (
        <div className="start-screen">
            ...
            <select name="select" defaultValue={""} onChange={getDeck}>
                ...
                <option value="Recall veícular">Deck de Recall Veícular</option>
            </select>
